...
class ShoppingCart extends DBController
{
    ...
    /*function getRechizite()
    {
        $query = "SELECT * FROM tbl_product WHERE categorie='rechizite'";

        $productResult = $this->getDBResult($query);
        return $productResult;
    }
    function getPapetarie()
    {
        $query = "SELECT * FROM tbl_product WHERE categorie='papetarie'";
    ...
    function getGenti()
    {
        $query = "SELECT * FROM tbl_product WHERE categorie='genti'";
    ...
    function getMemberCartItem($member_id)
    {
        ...
        FROM tbl_product, tbl_cart WHERE tbl_product.id = tbl_cart.product_id 
